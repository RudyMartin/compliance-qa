"""
Path Manager - Core Foundational Utility

Moved from tidyllm/infrastructure/path_utils.py to core/utilities/
...
class PathManager:
    ...
    def _initialize_paths(self):
        ...
        self._config_folder = system_config.get("config_folder", "core/config")
    ...
    def config_folder(self) -> str:
        """Get the config folder path (core/config)."""
    ...
    def core_folder(self) -> str:
        """Get the core folder path (foundational utilities)."""
        return os.path.join(self.root_folder, "core")
    ...
    def get_architecture_summary(self) -> Dict[str, str]:
        ...
        return {
            ...
            "core": self.core_folder,
            "config": self.config_folder,
