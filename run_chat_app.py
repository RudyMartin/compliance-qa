#!/usr/bin/env python3
"""
Chat Portal Launcher
====================
Launches the unified Chat portal.
"""
...
def main():
    ...
    portal_file = Path(path_mgr.get_portal_path("chat")) / "chat_app.py"
    ...
    try:
        subprocess.run([
            ...
            "--server.port", "8502",  # Chat Test Portal port
