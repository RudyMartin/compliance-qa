#!/usr/bin/env python3
"""
Flow Portal Launcher
====================
Launches the Flow workflow management portal.
"""
...
def main():
    ...
    portal_file = Path(path_mgr.get_portal_path("flow")) / "flow_app.py"
    ...
    try:
        subprocess.run([
            ...
            "--server.port", "8550",  # Flow Creator port
